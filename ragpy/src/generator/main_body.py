...
import sys
import sys
sys.path.append('C:\\Users\\shiva\\OneDrive\\Desktop\\Boltzman_labs\\fraem\\ragpy')
...
if __name__=="__main__":
    path = "C:\\Users\\shiva\\OneDrive\\Desktop\\Boltzman_labs\\fraem\\config.yaml"
    ...
    if args.context:
        ...
        rag_object = Generator_response(config=data,query=args.query,db=".\\ragpy\\vectorstores_chroma",embedding=embedding_function)
